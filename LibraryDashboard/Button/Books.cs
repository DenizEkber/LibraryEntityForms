...
namespace LibraryDashboard
{
    internal class Books : Panel
    {
        ...
        private Panel CreateBookPanel(dynamic book)
        {
            ...
            // Book Image
            PictureBox pictureBox = PanelHelper.CreatePictureBox(book.PhotoData, @$"C:\Users\{Environment.UserName}\Documents\C#\MixProject\LibraryEntityForms\LibraryDashboard\icon\profileImage.jpg", new Size(100, 150), new Point(10, 10));
